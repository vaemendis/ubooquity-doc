...
```
Ubooquity
│   preferences.json      ──>  The preferences you set up on the admin page (shared directories, users, etc.) 
│   ubooquity─5.mv.db     ──>  The Database containing the list and metadata of your comics and ebooks
│   Ubooquity.jar         ──>  The jar you download from the Ubooquity web site (just replace it to update)
